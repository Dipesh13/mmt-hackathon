...
list_df = [[1,5,'bob',1],[2,6,'foo',1],[3,7,'foo bar',1],[4,8,'bob',1]]
...
#     print(data_frame.apply(lambda x: " ".join(x), axis=1))
...
# print(X)
X_train, X_test, y_train, y_test = train_test_split(df[[0,1,2]], df[3], test_size = 0.4, random_state=42)
